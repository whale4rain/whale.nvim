...
map("<leader>fl", function() Snacks.picker.picker_layouts() end, "Find picker layout")
map("<leader>fk", function() Snacks.picker.keymaps({ layout = "dropdown" }) end, "Find keymap")
map("<leader><leader>", function() Snacks.picker.buffers({ sort_lastused = true }) end, "Find buffers")
map("<leader>fm", function() Snacks.picker.marks() end, "Find mark")
map("<leader>fn", function() Snacks.picker.notifications({ layout = "dropdown" }) end, "Find notification")
map("grr", function() Snacks.picker.lsp_references() end, "Find lsp references")
map("<leader>fS", function() Snacks.picker.lsp_workspace_symbols() end, "Find workspace symbol")
...
map("<leader>fI", function() Snacks.picker.lsp_incoming_calls() end, "Find incoming calls")
map("<leader>fO", function() Snacks.picker.lsp_outgoing_calls() end, "Find outgoing calls")
map("<leader>fb", function() Snacks.picker.lines() end, "Find lines in current buffer")
map("<leader>fd", function() Snacks.picker.diagnostics_buffer() end, "Find diagnostic in current buffer")
map("<leader>fH", function() Snacks.picker.highlights() end, "Find highlight")
map("<leader>fc", function() Snacks.picker.files({ cwd = vim.fn.stdpath("config") }) end, "Find nvim config file")
map("<leader>f/", function() Snacks.picker.search_history() end, "Find search history")
map("<leader>fj", function() Snacks.picker.jumps() end, "Find jump")
map("<leader>bc", function() Snacks.bufdelete.delete() end, "Delete buffers")
map("<leader>bC", function() Snacks.bufdelete.other() end, "Delete other buffers")
